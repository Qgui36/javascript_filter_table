...
var inputDate = "";
var inputCity = "fulf breeze";
  // filter through the data and find the matched data
// var filterDate = data.filter(result => (result.datetime == inputDate));

// console.log(filterDate)

function filterDate(result) {
  if (result.datetime == inputDate) {
    return result;}
  else if (result.city == inputCity) {
    return result;}
  else if (inputDate == "") {
    return result;}
  }
  
var filterDate = data.filter(filterDate);
